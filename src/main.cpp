...
String MQTT_Subscribe_Topic[MQTT_Subscribe_Topic_Number_Of] = {"/Boat/Settings/" + WiFi_Hostname + "/#", "/Boat/Buzzer/" + WiFi_Hostname};

#define BoatAll 1
#define BoatBuzzerHostname 2
...
void Buzzer_Play() {
  ...
  // Play
    ...
    tone(Buzzer_Pin, Tone); // UNCOMMENT ME
...
// ############################################################ Buzzer() ############################################################
void Buzzer(String Topic, String Payload) {
  if (Topic.indexOf(MQTT_Subscribe_Topic[BoatBuzzerHostname]) != -1) {
